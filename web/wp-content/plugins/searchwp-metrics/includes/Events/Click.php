...
class Click {
	...
	function __construct( \SearchWP_Metrics\Search $search, $url_param ) {
		...
		$this->add_click_tracking_to_live_ajax_search();
	}
	...
	/**
	 * Adds click tracking to Live Ajax Search results.
	 *
	 * @since 1.4.7
	 */
	private function add_click_tracking_to_live_ajax_search() {
		// Start Metrics tracking before the live search template is loaded.
		add_action(
			'searchwp_live_search_before_load_template',
			function () {
				/**
				 * Fires to start click tracking.
				 *
				 * @since 1.0
				 */
		...
		// Stop Metrics tracking after the live search template is loaded.
		add_action(
			'searchwp_live_search_after_load_template',
			function () {
				/**
				 * Fires to stop click tracking.
				 *
				 * @since 1.0
				 */
