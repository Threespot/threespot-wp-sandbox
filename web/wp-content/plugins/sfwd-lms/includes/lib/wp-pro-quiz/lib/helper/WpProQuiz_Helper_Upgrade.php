...
class WpProQuiz_Helper_Upgrade {
	...
	private static function updateV20() {
		...
		$results = $wpdb->get_results("
			...
			FROM ". LDLMS_DB::get_table_name( 'quiz_question' ) ." WHERE answer_type = 'cloze_answer' AND answer_points_activated = 1", ARRAY_A);
	...
	private static function updateV21() {
		...
		$results = $wpdb->get_results("
				...
				FROM ". LDLMS_DB::get_table_name( 'quiz_question' ), ARRAY_A);
