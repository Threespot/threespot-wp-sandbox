...
class Ajax {
	...
	public function get_search_results() {
		...
		add_filter( 'searchwp\query\args', [ $this, 'set_query_fields' ], 999 );
		...
		remove_filter( 'searchwp\query\args', [ $this, 'set_query_field' ] );
	...
	/**
	 * Set the query fields to return from the search query.
	 *
	 * @since 1.3.9
	 *
	 ...
	 * @return array
	 */
	public function set_query_fields( $args ) {

		$args['fields'] = 'all';
		$args['site']   = is_multisite() ? [ get_current_blog_id() ] : 'all';
