...
!(function (a) {
    ...
    (function (a) {
        ...
        a.extend(a.fn.editableform.Constructor.prototype, {
            ...
            (a.fn.editableform.buttons =
                '<button type="submit" class="btn btn-primary btn-sm editable-submit"><i class="fa fa-check"></i></button><button type="button" class="btn btn-default btn-sm editable-cancel"><i class="fa fa-remove"></i></button>'),
    ...
    (function (a) {
        ...
        e.prototype = {
            ...
            getFormattedDate: function (a) {
                return (
                    void 0 === a && (a = this.o.format), l.formatDate(this.date, a, this.o.language)
                );
            },
