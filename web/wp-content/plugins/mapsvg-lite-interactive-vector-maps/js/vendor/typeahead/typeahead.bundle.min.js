        ...
        f = (function () {
            ...
            return (
                b.mixin(c.prototype, {
                    ...
                    get: function (a) {
                        return (
                            this.isExpired(a) && this.remove(a), f(this.ls.getItem(this._prefix(a)))
                        );
                    },
                    set: function (a, c, f) {
                        return (
        ...
        g = (function () {
            ...
            function c(a) {
                (a = a || {}),
                    ...
                    (this._cache = a.cache === !1 ? new e(0) : g);
            }
            var d = 0,
                f = {},
                g = new e(10);
            ...
            g = (function () {
                ...
                function c(c, e) {
                    (c = c || {}),
                        ...
                        a(e.menu).attr("id", this.$input.attr("id") + "_listbox"),
                    ...
                    b.mixin(c.prototype, {
                        ...
                        autocomplete: function (a) {
                            ...
                            return (
                                ...
                                (c = this.menu.getSelectableData(a)),
                                (d = c && b !== c.val),
                                !(!d || this.eventBus.before("autocomplete", c.obj, c.dataset)) &&
                        ...
                        moveCursor: function (a) {
                            ...
                            return (
                                ...
                                (f = d ? d.dataset : null),
                                (h = c ? c.attr("id") : null),
                                this.input.trigger("cursorchange", h),
                                (g = this._minLengthMet() && this.menu.update(b)),
                                !g &&
                    ...
                    initialize: function (e, m) {
                        function n() {
                            ...
                            b.each(m, function (a) {
                                ...
                                (A = u ? k : i),
                                (v = new d({ el: c })),
                                (w = new g({ hint: r, input: c }, p)),
                                (x = new A({ node: s, datasets: m }, p)),
                                (y = new j({ $input: c, menu: x })),
                                (z = new l(
                                    {
                                        input: w,
                                        menu: x,
