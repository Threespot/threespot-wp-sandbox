...
!(function (a) {
    ...
    b.prototype = {
        ...
        toString: function (a) {
            ...
            switch (a) {
                ...
                case "rgba":
                    return (
                        (b = this.toRGB()), "rgba(" + b.r + "," + b.g + "," + b.b + "," + b.a + ")"
                    );
                case "hsl":
                    return (
                        (b = this.toHSL()),
        ...
        colorNameToHex: function (a) {
            return (
                "undefined" != typeof this.colors[a.toLowerCase()] && this.colors[a.toLowerCase()]
            );
        },
    };
    var c = {
            ...
            input: "input",
            container: !1,
            component: ".add-on, .input-group-text",
            sliders: {
                saturation: {
                    maxLeft: 100,
                    maxTop: 100,
    ...
    (d.Color = b),
        (d.prototype = {
            ...
            hide: function (event) {
                if (a(event.target).closest(".colorpicker").length) return;
            ...
            updateData: function (a) {
                return (
                    (a = a || this.color.toString(this.format)), this.element.data("color", a), a
                );
            },
            ...
            mousedown: function (b) {
                if (a(b.target).is("input")) {
                    ...
                    a(b.target).closest(".colorpicker").find("input").blur();
                }
                !b.pageX &&
                    !b.pageY &&
                    b.originalEvent &&
