...
!(function (a) {
        ...
        k = function (b, c) {
            a(b).data("datepicker", this),
                ...
                (this.component = this.element.hasClass("date")
                    ? this.element.find(".add-on, .input-group-text, .btn")
                    : !1),
    ...
    k.prototype = {
        ...
        setStartDate: function (a) {
            return (
                this._process_options({ startDate: a }), this.update(), this.updateNavArrows(), this
            );
        },
        getEndDate: function () {
        ...
        setEndDate: function (a) {
            return (
                this._process_options({ endDate: a }), this.update(), this.updateNavArrows(), this
            );
        },
        ...
        keydown: function (a) {
            if (!this.picker.is(":visible"))
                return void (
                    40 === a.keyCode /*||27===a.keyCode*/ && (this.show(), a.stopPropagation())
                );
            var b,
                c,
                d = !1,
